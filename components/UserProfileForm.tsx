  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.tagsContainer}>
            {['السكري', 'ضغط الدم المرتفع', 'ضغط الدم المنخفض', 'أمراض القلب', 'الكوليسترول المرتفع', 'حساسية الجلوتين', 'القولون العصبي', 'الكلى', 'الكبد الدهني', 'النقرس', 'فقر الدم', 'الغدة الدرقية'].map((condition) => (
              <TouchableOpacity
                key={condition}
                style={[
                  styles.tagButton,
      ...
      <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
        <Text style={styles.submitButtonText}>{initialData ? 'حفظ التعديلات' : 'حساب الاحتياجات الغذائية'}</Text>
      </TouchableOpacity>
